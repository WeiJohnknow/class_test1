...
vel=50
pos=2048
Goal_vels =np.ones(22)*vel
Goal_poss =np.ones(22)*pos
    ...
    if byte_r == 2:
        ...
        while True:
            ...
            for i in range(len(Read_inds)):
                ...
                #key
                Data_cur['ID'+str(Read_inds[i])+' : ']=Data_cur_value[-1]
                Data_vel['ID'+str(Read_inds[i])+' : ']=Data_vel_value[-1]
                Data_pos['ID'+str(Read_inds[i])+' : ']=Data_pos_value[-1]
